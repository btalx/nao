...
| [build-custom-charts](./build-custom-charts)   | Create, debug, or extend custom chart types ("vibe coded charts") as ES module plugins in `agent/charts/`, rendered through the normal `display_chart` tool.                                                                             | When the project needs a chart type beyond nao's built-ins.                                           |
